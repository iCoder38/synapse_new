            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) => AddEditEducationScreen(
                  strGetFirebaseIdForAddEducation: widget.strFirebaseId,
                ),
              ),
            );
          },
                ...
                return (getSnapShopValue.isEmpty)
                    ...
                    title: Text('title'),
                        ...
                        itemBuilder: (context, index) {
                          return ListTile(
                            title: text_bold_comforta(
                              getSnapShopValue[index]['schoolName'].toString(),
                              Colors.black,
                              22.0,
                            ),
                            subtitle: text_bold_comforta(
                              getSnapShopValue[index]['degree'].toString(),
                              Colors.black,
                              12.0,
                            ),
                            trailing: IconButton(
